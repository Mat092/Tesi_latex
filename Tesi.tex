...
\begin{figure}[H]
 \centering
 \includegraphics[scale = 0.5]{images/median-3}
 \includegraphics[scale = 0.5]{images/median-5}
 \caption{\textit{In figura viene mostrato il risultato di 10000 estrazioni di 3 (a sinistra) e 5 (a destra) interi casuali dai quali viene estratta la mediana. Aumentando il numero di numeri casuali da cui estrarre la mediana il picco si stringe e si alza }}
 \label{median}
\end{figure}
...
\begin{enumerate}
 \item[-] Collegamenti
 \item[-] Numero di neuroni del layer con più piccolo
