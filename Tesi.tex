...
La simulazione consiste nell'evoluzione di una popolazione iniziale randomica di neural network tramite le tipiche metodologie di un algoritmo genetico, adattate al caso particolare di funzione senza un predeterminato numero di variabili, il quale diventa un parametro della ricerca.
