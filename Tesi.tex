...
Infine vengono tratte le relative conclusione e vengono proposti sviluppi futuri sull'algoritmo.
...
Dalla cosiddetta "\textit{Hebbian Theory}" deriva il modello computazionale di rete neurale di  Warren McCulloch e Walter Pitts chiamato "\textit{Threshold logic}" che aprì la ricerca sulle reti neurali e portò in seguito al più moderno "\textit{Perceptron}".
